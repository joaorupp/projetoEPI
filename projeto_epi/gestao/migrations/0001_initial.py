# Generated by Django 5.2.5 on 2026-05-09 19:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perfil', models.CharField(choices=[('admin', 'Administrador do Sistema'), ('operador', 'Operador de Almoxarifado')], default='operador', max_length=10, verbose_name='Perfil de Acesso')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_responsavel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Responsável pela Saída')),
